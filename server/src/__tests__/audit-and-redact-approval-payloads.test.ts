...
import {
  ...
  redactHireApprovalPayloadForPersistence,
...
describe("hire approval payload custody", () => {
  ...
  it("redacts legacy unredacted plaintext sensitive secrets in historical approval payloads", () => {
    const historicalPayload = {
      ...
      adapterConfig: {
        env: {
          OPENAI_API_KEY: { type: "plain", value: "sk-historical-plaintext-secret" },
    ...
    const redacted = redactHireApprovalPayloadForPersistence(historicalPayload);
