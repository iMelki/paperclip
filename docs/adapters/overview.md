...
| [Gemini Local](/adapters/gemini-local) | `gemini_local` | Legacy Gemini CLI adapter, blocked by default; use Antigravity CLI (`agy`) for current Google account-backed CLI work |
