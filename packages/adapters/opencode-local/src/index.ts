...
- dangerouslySkipPermissions (boolean, optional): inject a runtime OpenCode config that allows \`external_directory\` access without interactive prompts. New UI-created agents default to false and require explicit opt-in; legacy configurations that omit the field retain the true runtime fallback for unattended compatibility
