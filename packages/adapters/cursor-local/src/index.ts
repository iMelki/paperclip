...
- Paperclip auto-adds --trust unless one of --trust/--yolo/-f is already present in extraArgs. It never auto-adds --yolo or -f. --trust only accepts workspace trust; it does not bypass command or MCP approvals.
