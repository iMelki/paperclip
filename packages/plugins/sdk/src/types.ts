...
export interface PluginHttpClient {
   ...
   * @param options - Optional company scope. Required for proactive calls that
   *   need a company-owned trusted-loopback rule; host-issued invocations can
   *   derive the same scope from their invocation context.
...
export interface PluginHttpFetchOptions {
  /** Company whose host-owned outbound policy should be applied. */
  companyId?: string;
}
