...
export interface WorkerToHostMethods {
  ...
  "http.fetch": [
    params: {
       ...
       *
       * Host-issued invocations may supply this scope implicitly. Proactive
       * worker calls must send it explicitly and are admitted only when the
       * company is in the worker's configured proactive scope set.
       */
      companyId?: string;
    },
