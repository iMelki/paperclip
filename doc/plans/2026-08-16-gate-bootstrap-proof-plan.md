...
| `scripts/run-pre-push-tests.mjs` | new | 393 | Git-protocol/HEAD/remote planner and runner dispatcher with repository-wide normal-index binding. |
| `scripts/run-pre-push-tests.test.mjs` | new | 252 | Protocol, authority, cleanliness, hidden-index, and exit fixtures. |
