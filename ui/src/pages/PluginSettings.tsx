...
export function PluginSettings() {
  ...
  const { data: dashboardData } = useQuery({
    queryKey: pluginId && selectedCompanyId
      ? queryKeys.plugins.dashboard(pluginId, selectedCompanyId)
      : ["plugins", pluginId ?? "__missing_plugin__", "companies", "__missing_company__", "dashboard"] as const,
  ...
  const { data: recentLogs } = useQuery({
    ...
    queryFn: () => pluginsApi.logs(pluginId!, selectedCompanyId!, { limit: 50 }),
