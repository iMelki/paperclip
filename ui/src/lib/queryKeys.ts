export const queryKeys = {
  ...
  agents: {
    ...
    adapterModels: (companyId: string, adapterType: string, environmentId: string | null = null) =>
      ["agents", companyId, "adapter-models", adapterType, environmentId] as const,
  ...
  plugins: {
    ...
    trustedLoopbackHttp: (pluginId: string, companyId: string) =>
      ["plugins", pluginId, "companies", companyId, "trusted-loopback-http"] as const,
    logs: (pluginId: string, companyId: string) =>
      ["plugins", pluginId, "companies", companyId, "logs"] as const,
  },
  adapters: {
